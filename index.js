...
/////////////////
const BotName = 'RIDO bot☄'; 
const instagram = 'gw gk punya ajg'; 
const telegram = 'gw gk punya ajg'; 
const kapanbotaktif = 'KALO DI AKTIFKAN LAH TOLOL!!'; 
const youtube = 'males gw kalian gk mau sasklep';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by rido gk ganteng')
